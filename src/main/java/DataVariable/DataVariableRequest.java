...
public class DataVariableRequest<queryParameters> {
	...
	public static Headers createRequestHeader(DataVariable datavariable) throws Throwable {
		...
		Header authorizationKeyHdr = new Header("Authorization", datavariable.getAuthorization());
		// Header authorizationKeyHdr = new Header("Authorization", /*"Bearer "+
		// bearerToken*/"");
...
/*	public static Headers createRequestParametersBase(DataVariable datavariable) {
	...
	public static Map<String, String> CreateQueryParameter(DataVariable datavariable) {
		...
		CreateQueryParamter.put("website-id", datavariable.getWebsite_id());
		CreateQueryParamter.put("page-number", datavariable.getPage_number());
		 CreateQueryParamter.put("keywords", datavariable.getKeywords());
		 CreateQueryParamter.put("manufacturer-name", datavariable.getManufacturer_name());
		// CreateQueryParamter = new Headers(website_id,page_number,keyword,manufacturer_name);
		return CreateQueryParamter;
